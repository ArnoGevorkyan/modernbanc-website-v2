...
<Tabs width="min">
  <Tab title="Method 1">
    ...
    <br/>
    <Image
      src="https://storage.googleapis.com/mdb-public-prod-bucket/docs-assets/quickstart/cc-to-provider-diagram-1.png"
      title="Process"
      max_height="500px"
    />
    <br/>
    ...
    <Process title="Create a trigger in the UI" index={1}>
      ...
      <Image
        src="https://storage.googleapis.com/mdb-public-prod-bucket/docs-assets/quickstart/quickstart-cc-to-p-trigger-1.png"
        title="Create new trigger"
        max_height="500px"
      />
      <Image
        src="https://storage.googleapis.com/mdb-public-prod-bucket/docs-assets/quickstart/quickstart-cc-to-p-trigger-2.png"
    ...
    <Process title="Create a workflow with `Condition` and `Connection query` steps" index={2}>
      ...
      <Image
        src="https://storage.googleapis.com/mdb-public-prod-bucket/docs-assets/quickstart/quickstart-cc-to-p-workflow.png"
        title=""
        max_height="500px"
      />
    </Process>
  ...
  <Tab title="Method 2">
    This method is similar to the first one except that instead of triggering workflow directly we'll create a transaction and the workflow will detect that there is a new transaction and act accordingly. We'll cover how to:
    ...
    <br/>
    <Image
      src="https://storage.googleapis.com/mdb-public-prod-bucket/docs-assets/quickstart/cc-to-provider-diagram-2.png"
      title="Process"
      max_height="500px"
    />
    <br/>
    ...
    The downside to this method is that you're limited to using transactions just for this use-case. This is because the workspace operation step listens to all transactions in the workspace.
