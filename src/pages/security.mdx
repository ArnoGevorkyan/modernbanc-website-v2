...
At Modernbanc we take your security extremely seriously and take advanced measure to protect our systems and data.
...
All of our services are hosted with Amazon Web Services (AWS) and Google Cloud Platform (GCP). They employ a robust security program with multiple certifications. For more information on our provider’s security processes, please visit AWS Security and GCP Security.
...
If you have any questions, comments or concerns or if you wish to report a potential security issue, please contact [security@modernbanc.com](mailto:security@modernbanc.com)
